...
<head>
    ...
    <title>CS4342 Create Advisor</title>
...
<body>
    ...
    <?php
        ...
        if (isset($_POST['Submit'])){
            ...
            $ADfirstName = isset($_POST['first_name']) ? $_POST['first_name'] : " ";
            $smiddleName = isset($_POST['middle_name']) ? $_POST['middle_name'] : " ";
            $slastName = isset($_POST['last_name']) ? $_POST['last_name'] : " ";
            
            //Insert into Student table;
            
            $queryStudent  = "INSERT INTO Student (ADId,SfirstName,SmiddleName,SlastName)
